  ...
  export default {
    ...
    data() {
      return {
        currentImageIndex: 0,
        people: [
          { name: 'John Doe', job: 'Développeur', image: '' },
          { name: 'Jane Smith', job: 'Designer', image: '' },
          { name: 'Alice Johnson', job: 'Chef de projet', image: '' },
          { name: 'Bob Brown', job: 'Analyste', image: '' },
          { name: 'Eva Martinez', job: 'Testeur', image: '' },
          { name: 'Michael Lee', job: 'Architecte', image: '' },
          { name: 'Sophie Wang', job: 'Développeur', image: '' },
          { name: 'David Kim', job: 'Designer', image: '' },
        ],
        visibleCount: 4,
